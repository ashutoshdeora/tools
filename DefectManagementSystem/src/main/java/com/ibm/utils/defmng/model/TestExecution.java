...
public class TestExecution implements Serializable {
	...
	@OneToMany(targetEntity=Defect.class)
	...
	/**
	 * @param testScriptName the testScriptName to set
	 */
	...
	/**
	 * @param testExecutionPhase the testExecutionPhase to set
	 */
	...
	/**
	 * @param featureTestRun the featureTestRun to set
	 */
	...
	/**
	 * @param accountTestRun the accountTestRun to set
	 */
	...
	/**
	 * @param featureRun the featureRun to set
	 */
	...
	/**
	 * @param accountRun the accountRun to set
	 */
	...
	/**
	 * @param testOwner the testOwner to set
	 */
	...
	/**
	 * @param rolloutStatus the rolloutStatus to set
	 */
	...
	/**
	 * @param totalTestScripts the totalTestScripts to set
	 */
	...
	/**
	 * @param testExecutionStatus the testExecutionStatus to set
	 */
	...
	/**
	 * @param siteRun the siteRun to set
	 */
	...
	/**
	 * @param routeRun the routeRun to set
	 */
